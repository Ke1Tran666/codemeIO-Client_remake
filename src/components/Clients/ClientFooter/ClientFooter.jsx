    ...
    return (
        <footer className="mt-12 py-12 bg-gray-100 border-t border-gray-200">
            <div className="px-4 max-w-[1320px] mx-auto">
                <div className="grid grid-cols-5 items-start text-[#444655] gap-5 leading-6 flex-1">
                ...
                <div className="text-[#444655] leading-6 mt-2 w-full max-w-[700px] text-center p-5 mx-auto">
